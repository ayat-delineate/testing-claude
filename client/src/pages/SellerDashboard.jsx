...
const SellerDashboard = () => {
  ...
  const navigation = [
    ...
    },
    {
      ...
      icon: Package,
      current: location.pathname === "/seller/medicines",
    },
    {
    ...
    },
    {
      ...
      icon: TrendingUp,
      current: location.pathname === "/seller/advertisements",
    },
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Seller dashboard for managing medicines and sales"
        />
      </Helmet>
            ...
            <main className="p-6">
              ...
              <div className="mb-8">
                ...
                <p className="text-gray-600 mt-2">
                  Manage your medicines and track your sales performance.
                </p>
              </div>
              ...
              <Routes>
                ...
                <Route
                  ...
                  element={
                    <div className="mt-8">
                      <p className="text-gray-600">
                        Advertisement requests coming soon...
                      </p>
                    </div>
                  }
                />
